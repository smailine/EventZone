...
INSERT INTO `client` (`id`, `nom`, `email`, `mdp`) VALUES
...
(1, 'image/prestataire/coiffure', 'coiffure', NULL, 1, 1),
(2, 'image/prestataire/coiffure1', 'coiffure', NULL, 1, 1),
(3, 'image/prestataire/coiffure2', 'coiffure', NULL, 1, 1),
(4, 'image/prestataire/deco', 'decoration', NULL, 3, 3),
(5, 'image/prestataire/deco1', 'decoration', NULL, 3, 3),
(6, 'image/prestataire/deco2', 'decoration', NULL, 3, 3),
(7, 'image/prestataire/dj', 'Dj\'s', NULL, 6, 2),
(8, 'image/prestataire/dj1\r\n', 'Dj\'s', NULL, 6, 2),
(10, 'image/prestataire/maquillage', 'maquillage', NULL, 2, 3),
(11, 'image/prestataire/maquillage1', 'maquillage', NULL, 2, 3),
(12, 'image/prestataire/maquillage2', 'maquillage', NULL, 2, 3),
(13, 'image/prestataire/wedding', 'mariage', NULL, 4, 3),
(14, 'image/prestataire/wedding1', 'mariage', NULL, 4, 3),
(15, 'image/prestataire/wedding2', 'mariage', NULL, 4, 3),
(16, 'image/prestataire/traiteur', 'traiteur', NULL, 7, 4),
(17, 'image/prestataire/traiteur1', 'traiteur', NULL, 7, 4),
(18, 'image/prestataire/salle', 'salle', 1, 8, 3),
(19, 'image/prestataire/salle1', 'salle', 1, 8, 3);
...
--
ALTER TABLE `annonce`
  ADD CONSTRAINT `PR_cli` FOREIGN KEY (`client`) REFERENCES `client` (`id`);

--
-- Contraintes pour la table `commentaire`
--
ALTER TABLE `commentaire`
  ADD CONSTRAINT `PR_cli_com` FOREIGN KEY (`client`) REFERENCES `client` (`id`),
